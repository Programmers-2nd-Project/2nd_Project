...
-- raw_data 밑에 테이블 생성
CREATE OR REPLACE TABLE pro2.raw_data.oil_price (
    oil_date timestamp,
    prodcd varchar(4),
    oil_type varchar(32),
    price float);
...
-- raw_data 밑에 테이블 생성
create or replace TABLE PRO2.RAW_DATA.Diesel_OIL_DATA (
	CODE NUMBER(38,0),
...
-- 데이터 확인
SELECT * FROM PRO2.RAW_DATA.Diesel_OIL_DATA;


-- 지역별 일반 휘발유 가격 데이터

-- raw_data 밑에 테이블 생성
create or replace TABLE PRO2.RAW_DATA.NG_OIL_DATA (
	CODE NUMBER(38,0),
	SIDO VARCHAR(16777216),
	PRICE NUMBER(38,2),
	LATITUDE NUMBER(38,4),
...
-- 데이터 확인
SELECT * FROM PRO2.RAW_DATA.NG_OIL_DATA;
