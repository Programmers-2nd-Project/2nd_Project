...
def main():
    ...
    # 데이터 프레임 생성
    data_frame = pd.DataFrame(DS_df, columns=['Code', 'SIDO', 'Price'])
...
bucket_name = '8-week-test-bucket' # 본인 버킷 이름
object_name = 'auto_test/Diesel_sido_oil_price.csv'  # 버킷 내의 특정 경로에 저장할 수 있도록 지정 >> 버킷내의 폴더 이름/csv저장 파일 이름
